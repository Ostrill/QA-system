...
- `ruBERT_after_DE_fine_tuning.ipynb` - тонкая настройка модели ruBERT после подбора значений гиперпараметров для AdamW алгоритмом дифференциальной эволюции;
